...
func resourcesAwswhitelistJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/AWSWhitelist.json", size: 11191, mode: os.FileMode(436), modTime: time.Unix(1628069276, 0)}
...
func resourcesDefaultsamplingrulesJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/DefaultSamplingRules.json", size: 97, mode: os.FileMode(436), modTime: time.Unix(1628069276, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func resourcesExamplesamplingrulesJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "resources/ExampleSamplingRules.json", size: 609, mode: os.FileMode(436), modTime: time.Unix(1628069276, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
